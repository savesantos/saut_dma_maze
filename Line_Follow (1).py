...
while True:
	try:
		...
		if(Sensors[0] >900 and Sensors[1] >900 and Sensors[2] >900 and Sensors[3] >900 and Sensors[4] >900):
			...
			strip.setPixelColor(0, Color(0, 100, 0))       #Red
			strip.setPixelColor(1, Color(0, 100, 0))       #Red
			strip.setPixelColor(2, Color(0, 100, 0))       #Red
			strip.setPixelColor(3, Color(0, 100, 0))       #Red
			strip.show()			
